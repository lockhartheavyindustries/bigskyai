...
metadata:
  ...
  category: marketing
  updated: "2026-03-06"
  source_commit: aa8d778811a557a2c28ccadda4cf3d0bd028a4cc
  adapted_for: Big Sky AI
---
...
Read `docs/marketing-context.md` and `README.md` before creating content. No
official Big Sky AI social publishing channel or scheduling pipeline is
documented in this repository; Brian's LinkedIn and the project GitHub account
are the only public identity links currently recorded. Verify any other account
live before describing it as official.

Preserve the distinction between installations, product concepts,
publications, and experiments. Use only approved, anonymized public source
material. Do not invent clients, testimonials, metrics, availability,
partnerships, endorsements, project status, or private details. Cadence tables
are references, not quotas. Drafting is not authority to post, schedule,
connect an account, or create a public profile.
...
### Example for Big Sky AI

| Pillar | % of Content | Topics |
|--------|--------------|--------|
| Practical installations | 25% | Human problem, system, verified result |
| How it works | 25% | Architecture, evidence, operations, plain-English tours |
| Approved stories | 20% | Anonymized Weekly Ralph examples and lessons |
| Governance | 15% | Privacy, limitations, human judgment, maintenance |
| Concepts and experiments | 10% | Transparent progress with exact status labels |
| Montana context | 5% | Bozeman and local relevance when genuine |
