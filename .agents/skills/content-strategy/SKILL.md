...
Read `docs/marketing-context.md` and `README.md` before asking questions.
Prioritize practical AI systems, transparent implementation evidence, approved
anonymized stories, governance, privacy, and genuine project updates. Preserve
the distinction between installations, concepts, publications, and
experiments. Do not invent clients, testimonials, results, product status, or
private details. Proposed topics remain strategy until their claims and source
material are approved for public use.
...
```bash
python3 .agents/skills/content-strategy/scripts/topic_cluster_mapper.py --file keywords.txt          # one topic/keyword per line
python3 .agents/skills/content-strategy/scripts/topic_cluster_mapper.py --file keywords.txt --json  # for pipelines
```
